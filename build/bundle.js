...
var app = (function () {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$b, 12, 3, 361);
    		},
    		m: function mount(target, anchor) {
    ...
    // (32:4) {#each languages as language}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(32:4) {#each languages as language}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(fa2, div11, null);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div12, "click", /*click_handler_2*/ ctx[4], false, false, false)
    				];
