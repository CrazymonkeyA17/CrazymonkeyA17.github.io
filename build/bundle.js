...
var app = (function () {
    ...
    const navbarmenu = ["ABOUT" ,"SKILLS", "CURRENT ROLE", "CAREER", "PROJECTS"];
    ...
    /* src\Contact.svelte generated by Svelte v3.42.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t11 = space();
    			t12 = text(linkedin);
    			attr_dev(h1, "class", "svelte-11479nh");
    			add_location(h1, file$2, 9, 4, 372);
    			attr_dev(li0, "class", "svelte-11479nh");
    			add_location(li0, file$2, 11, 6, 405);
    			attr_dev(li1, "class", "svelte-11479nh");
    			add_location(li1, file$2, 12, 6, 466);
    			attr_dev(li2, "class", "svelte-11479nh");
    			add_location(li2, file$2, 13, 6, 527);
    			attr_dev(li3, "class", "svelte-11479nh");
    			add_location(li3, file$2, 14, 6, 587);
    			add_location(ul, file$2, 10, 4, 393);
    			attr_dev(div0, "class", "svelte-11479nh");
    			add_location(div0, file$2, 8, 2, 361);
    			attr_dev(div1, "class", "left svelte-11479nh");
    			add_location(div1, file$2, 7, 0, 339);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div0, ul);
    			append_dev(ul, li0);
    			mount_component(fa0, li0, null);
    			append_dev(li0, t2);
    			append_dev(li0, t3);
    			append_dev(ul, t4);
    			append_dev(ul, li1);
    			mount_component(fa1, li1, null);
    			append_dev(li1, t5);
    			append_dev(li1, t6);
    			append_dev(ul, t7);
    			append_dev(ul, li2);
    			mount_component(fa2, li2, null);
    			append_dev(li2, t8);
    			append_dev(li2, t9);
    			append_dev(ul, t10);
    			append_dev(ul, li3);
    			mount_component(fa3, li3, null);
    			append_dev(li3, t11);
    			append_dev(li3, t12);
    			current = true;
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			attr_dev(li, "class", "svelte-2zmkrr");
    			add_location(li, file$1, 5, 30, 133);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(6:4) {#each navbarmenu as item}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 4, 2, 97);
    			attr_dev(div, "class", "right svelte-2zmkrr");
    			add_location(div, file$1, 3, 0, 74);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-zadoqd");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Contact, Navbar });
    	return [];
    }
